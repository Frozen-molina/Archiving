...
<title>Sorsogon State College-Bulan Campus: <?php echo $title; ?></title>
	    ...
	    <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">Sorsogon State College-Bulan Campus</a>
	        </div>
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li><a href="<?php echo WEB_ROOT; ?>index.php?page=5"></a></li>
				...
				<!-- <img  width="1100px" hieght="100px" class="img-rounded"/> -->
					<div class="media">
					  <a class="pull-left" href="#">
					    <img class="media-object" src="<?php echo WEB_ROOT; ?>img/sscbclogo.png" alt="...">
					  </a>
					</div>
				</div>
			</div>
